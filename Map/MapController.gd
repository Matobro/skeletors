...
func _ready():
	grid_manager = preload("res://Map/GridManager.gd").new()
	astar_manager = preload("res://Map/AStarManager.gd").new()
	unit_manager = preload("res://Map/UnitManager.gd").new()
	path_request_manager = preload("res://Map/PathRequestManager.gd").new()
